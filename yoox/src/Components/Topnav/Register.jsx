...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    axios
      .post(`https://yoox-server.onrender.com/user`, {
  ...
  return (
    <div>
      ...
      <div className={style.SOCIALRegi}>
        ...
        <div>
          <Button w="400px" colorScheme="facebook">
            facebook
          </Button>
        </div>
      ...
      <div className={style.RegiformDiv}>
        ...
        <form>
          ...
          <div className={style.RadioDiv}>
            <RadioGroup w="400px" defaultValue="1" >
              <Stack spacing={4} direction="row" >
                <Radio name="gender" value="FEMALE" onChange={handleChange} >
                  FEMALE
                </Radio>
                <Radio name="gender" value="MALE" onChange={handleChange}>
                  MALE
                </Radio>
              </Stack>
            </RadioGroup>
          ...
          <div className={style.checkboxDiv}>
            <Checkbox size="sm" colorScheme="green" fontSize="12px" value=""><h3>
              ...
              that correspond to my interests.
              </h3></Checkbox>
          </div>
